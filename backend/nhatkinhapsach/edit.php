...
$ma = $_GET['nkns_ms'];
$sqlSelect = "SELECT * FROM `nhatkinhapsach` WHERE MASACH='$ma';";
...
if(isset($_POST['btnSave'])) 
{
    ...
    // Câu lệnh UPDATE
    $sql = "UPDATE `nhatkinhapsach` SET SOLUONG='$soluong' WHERE MASACH='$ma';";
...
echo $twig->render('backend/nhatkinhapsach/edit.html.twig', ['nhatkinhapsach' => $loaisanphamRow] );